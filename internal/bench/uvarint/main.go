...
func doCase(n int, head bool, start time.Time) {
	...
	fmt.Printf("%-20s", "LittleRead")
	dur, speed, size = DoBenchUvarint(BenchStdWrite, LittleUvarintRead, _doCnt)
	fmt.Printf("%-10s", dur.String())
	fmt.Printf("%-10s", size.String())
	dur, speed, size = DoBenchUvarint(BenchEncode, LittleUvarintRead, _doCnt)
	fmt.Printf("%-10s", dur.String())
	fmt.Printf("%-10s", size.String())
	fmt.Printf("\n")

	fmt.Printf("%-20s", "BigRead")
	dur, speed, size = DoBenchUvarint(BenchStdWrite, BigUvarintRead, _doCnt)
	fmt.Printf("%-10s", dur.String())
	fmt.Printf("%-10s", size.String())
	dur, speed, size = DoBenchUvarint(BenchEncode, BigUvarintRead, _doCnt)
	fmt.Printf("%-10s", dur.String())
	fmt.Printf("%-10s", size.String())
	fmt.Printf("\n")

	fmt.Printf("%-20s", "LittleReadFile")
	dur, speed, size = DoBenchUvarint(BenchStdWrite, LittleUvarintReadFile, _doCnt)
	fmt.Printf("%-10s", dur.String())
	fmt.Printf("%-10s", size.String())
	dur, speed, size = DoBenchUvarint(BenchEncode, LittleUvarintReadFile, _doCnt)
	fmt.Printf("%-10s", dur.String())
	fmt.Printf("%-10s", size.String())
	fmt.Printf("\n")

	fmt.Printf("%-20s", "BigReadFile")
	dur, speed, size = DoBenchUvarint(BenchStdWrite, BigUvarintReadFile, _doCnt)
	fmt.Printf("%-10s", dur.String())
	fmt.Printf("%-10s", size.String())
	dur, speed, size = DoBenchUvarint(BenchEncode, BigUvarintReadFile, _doCnt)
	fmt.Printf("%-10s", dur.String())
	fmt.Printf("%-10s", size.String())
	fmt.Printf("\n")
